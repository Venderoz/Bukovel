...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .mountains {
        background-image: url("./assets/main-page-waves.svg");
  ...
  <body>
      ...
      <div class="content">
        ...
        <div class="sidebar-list-box">
          <ul>
            ...
            <li>
              <a href="" id="shopping-basket-logo-box">
                <!-- inserted with JS -->
              </a>
            </li>
            <li>
              <a href="" id="account-logo-box">
                <!-- inserted with JS -->
              </a>
            </li>
            <li>
    ...
    <header>
      <nav>
        <div class="logo-box">
          <a href="welcomePage.html" id="main-logo-box">
            <!-- Inserted with JS -->
          </a>
        </div>
      ...
      <div class="swiper">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <figure>
              <img src="./assets/Bukovel1.png" alt="Bukovel1.png" />
          ...
          <div class="swiper-slide">
            <figure>
              <img src="./assets/Bukovel2.png" alt="Bukovel2.png" />
          ...
          <div class="swiper-slide">
            <figure>
              <img src="./assets/Bukovel3.png" alt="Bukovel3.png" />
    ...
    <!-- ----------------------------------------------------------------------- -->
    <script src="./scripts/change-theme.js"></script>
    <script src="./scripts/sidebar-manipulation.js"></script>
